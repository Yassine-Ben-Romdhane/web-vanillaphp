...
<div class="hero">
  ...
  <div class="hero-content">
    <button class="button">
      <div class="text-wrapper">HISTORY</div>
    </button>
...
<div class="element history-section" data-reveal="left">
  <p class="element-first-world-cup">
    ...
    <span class="text-wrapper-2">Participation in the 1978 FIFA World Cup in Argentina was a continental turning point.
      Tunisia became the
...
<div class="element-4 history-section" data-reveal="right">
  ...
  <p class="p">
    ...
    <span class="text-wrapper-2">After difficult years (missing six AFCON tournaments between 1978 and 1994), Tunisia
...
<div class="div history-section" data-reveal="left">
  <p class="element-african">
    ...
    <span class="text-wrapper-2">The absolute high point: winning the 2004 Africa Cup of Nations, hosted at
      home.<br />Under the leadership
...
<div class="element-6 history-section" data-reveal="right">
  ...
  <p class="p">
    ...
    <span class="text-wrapper-2">Qualification for the 2018 FIFA World Cup ended 12 years of absence from the global
      stage.<br />Even if the
...
<div class="element-3 history-section" data-reveal="left">
  <p class="element-victory-against">
    ...
    <span class="text-wrapper-2">During the 2022 FIFA World Cup, Tunisia defeated the France national team 1-0 in the
      group stage.<br />Although
